...
var SwipeActionsEventData = (function () {
    function SwipeActionsEventData() {
    }
    Object.defineProperty(SwipeActionsEventData.prototype, "eventName", {
        get: function () {
    ...
    Object.defineProperty(SwipeActionsEventData.prototype, "object", {
        get: function () {
            return this._object;
        },
        set: function (value) {
    ...
    Object.defineProperty(SwipeActionsEventData.prototype, "itemIndex", {
        get: function () {
    ...
    Object.defineProperty(SwipeActionsEventData.prototype, "data", {
        get: function () {
            return this._data;
        },
        set: function (value) {
...
var RadListView = (function (_super) {
    ...
    Object.defineProperty(RadListView.prototype, "swipeActions", {
        get: function () {
            return this._getValue(RadListView.swipeActionsProperty);
        },
        set: function (value) {
            this._setValue(RadListView.swipeActionsProperty, value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(RadListView.prototype, "scrollPosition", {
        get: function () {
            return this._getValue(RadListView.scrollPositionProperty);
        },
        set: function (value) {
            this._setValue(RadListView.scrollPositionProperty, value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    RadListView.prototype.getViewForViewType = function (viewType) {
    ...
    RadListView.onSwipeActionsPropertyChanged = function (data) {
        var lv = data.object;
        lv.onSwipeActionsChanged(data);
    };
    ...
    RadListView.onScrollPositionPropertyChanged = function (data) {
        var listView = data.object;
        listView.onScrollPositionPropertyChanged(data);
    };
    ...
    RadListView.prototype.onSwipeActionsChanged = function (data) {
    };
    ...
    RadListView.prototype.onScrollPositionPropertyChanged = function (data) {
    };
    ...
    RadListView.swipeActionsProperty = new dependencyObservable.Property("swipeActions", "RadListView", new proxyModule.PropertyMetadata(undefined, dependencyObservable.PropertyMetadataSettings.None, RadListView.onSwipeActionsPropertyChanged));
    ...
    RadListView.scrollPositionProperty = new dependencyObservable.Property("scrollPosition", "RadListView", new proxyModule.PropertyMetadata(undefined, dependencyObservable.PropertyMetadataSettings.None, RadListView.onScrollPositionPropertyChanged));
    return RadListView;
})(viewModule.View);
