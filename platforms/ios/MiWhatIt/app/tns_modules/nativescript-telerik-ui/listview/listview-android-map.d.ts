    ...
    module telerik {
        module widget {
            module list {
                ...
                module SwipeActionsBehavior {
                    enum SwipeDockMode {
                        DockAtLimit,
                        DockAtThreshold
                    }
                    interface SwipeActionsListener {
                        onSwipeStarted(eventInfo: SwipeActionEvent);
                        onSwipeProgressChanged(eventInfo: SwipeActionEvent);
                        onSwipeEnded(eventInfo: SwipeActionEvent);
                        onExecuteFinished(eventInfo: SwipeActionEvent);
                        onSwipeStateChanged(oldState, newState);
                        swipeLimits: any;
                    }
                    class SwipeActionEvent {
                        swipePositionWhenReleased(): number;
                        swipedItemPosition(): number;
                        swipeView();
                        mainView();
                        currentOffset(): number;
                        isThresholdPassed(): boolean;
                    }
                    class SwipeActionsListener {
                        constructor(impl: SwipeActionsListener);
                    }
                }
                ...
                class SwipeActionsBehavior extends ListViewBehavior {
                    constructor();
                    addListener(listener: com.telerik.widget.list.SwipeActionsBehavior.SwipeActionsListener);
                    endExecute(): void;
                    setDockMode(dockMode: com.telerik.widget.list.SwipeActionsBehavior.SwipeDockMode);
                    setSwipeThresholdStart(value: number);
                    setSwipeThresholdEnd(value: number);
                    getSwipeLimitStart(): number;
                    setSwipeLimitStart(value: number);
                    getSwipeLimitEnd(): number;
                    setSwipeLimitEnd(value: number);
                }
