        ...
        get: function () {
            if (!this._swipeLimits) {
                this._swipeLimits = (this._owner.listViewLayout.scrollDirection === "Vertical") ?
                    { left: this._owner.getMeasuredWidth(), top: 0, right: this._owner.getMeasuredWidth(), bottom: 0, threshold: 0 } :
                    { left: 0, top: this._owner.getMeasuredHeight(), right: 0, bottom: this._owner.getMeasuredHeight(), threshold: 0 };
            }
    ...
    TKListViewDelegateImpl.prototype.listViewShouldSwipeCellAtIndexPath = function (listView, cell, indexPath) {
        ...
        if (shouldSwipe) {
            ...
            var startArgs = {
                ...
                object: viewAtIndex.itemSwipeView,
...
var RadListView = (function (_super) {
    ...
    RadListView.prototype.onSwipeActionsChanged = function (data) {
        _super.prototype.onSwipeActionsChanged.call(this, data);
        this.synchCellSwipe();
    };
        ...
        if (this._ios) {
            if (!this.scrollPosition) {
                if (this.listViewLayout.scrollDirection === commonModule.ListViewScrollDirection.Vertical) {
                    ...
                    this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionLeft, false);
                }
            }
            else {
                switch (this.scrollPosition) {
                    case commonModule.ListViewScrollPosition.Bottom:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionBottom, false);
                        break;
                    case commonModule.ListViewScrollPosition.CenteredHorizontally:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionCenteredHorizontally, false);
                        break;
                    case commonModule.ListViewScrollPosition.CenteredVertically:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionCenteredVertically, false);
                        break;
                    case commonModule.ListViewScrollPosition.Left:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionLeft, false);
                        break;
                    case commonModule.ListViewScrollPosition.None:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionNone, false);
                        break;
                    case commonModule.ListViewScrollPosition.Right:
                        this._ios.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), UICollectionViewScrollPosition.UICollectionViewScrollPositionRight, false);
                        break;
